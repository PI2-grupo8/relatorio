...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=.7]{cond_contorno.eps}
	\caption{Condições de contorno da simulação}
\end{figure}

\begin{figure}[!htbp]
	\centering
	\includegraphics[width=.7]{carga_distribuida1.eps}
	\caption{Carga distribuida da simulação}
\end{figure}

\begin{figure}[!htbp]
	\centering
	\includegraphics[width=.7]{carga_distribuida2.eps}
	\caption{Carga distribuida da simulação}
\end{figure}

\begin{figure}[!htbp]
	\centering
	\includegraphics[width=.7]{zoom_suporte.eps}
