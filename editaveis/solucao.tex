\chapter{Solução}
  ...
  \subsection{Tração}
	...
	\caption{Modelo de rodas}
      ...
      atende bem a proposta. (Matsumura, Takao.)
  ...
  \subsection{Energia}
    ...
    elevado e a satisfatória associação do servomotor com sensores cumprem os requisitos no projeto.
     ...
     tensão (MAGALHÃES, 2011 e SILVA, 2011).
     ...
     (Ampère x hora) (MEGGLIARO, 2006).
     
     A capacidade de descarga é quanto a bateria consegue fornecer sem que ocorra um superaquecimento, que poderia 
     causar danos imensos a todo o projeto. Ela vem representada nas especificações pela letra C (MEGGLIARO, 2006).
     ...
     descarga, longos ciclos de vida e segurança no manuseio (CASTILLO, 2002).
     ...
     (ANDRADE, 2005). Se apresentam em dois formatos: seladas e não seladas, sendo que nesta segunda existe a necessidade de 
